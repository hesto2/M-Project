package{
	...
	public class Samus extends MovieClip {
		//Change jump logic on ground to be global move logic that checks if bottom is false, if not and not jumping, then fall.
		...
		*/
		...
		public var level = C.LEVEL;
		public var cList = new CollisionList(this,level);
		public var cThresh = 45
		...
		//Hit Test Points
		public var topRightBumpPoint = new Point(15,-37);
		public var topLeftBumpPoint = new Point(-15,-37);
		public var bottomRightBumpPoint = new Point(15,37);
		public var bottomLeftBumpPoint = new Point(-15,37);
		public var bottomBumpPoint = new Point(0,37);
		public var leftBumpPoint = new Point(-15,0);
		public var rightBumpPoint = new Point(15,0);
		public var topBumpPoint = new Point(0,-37);
		
		
		
		//Ball Test Points

		public var topRightBallPoint = new Point(70,-140);
		public var topLeftBallPoint = new Point(-70,-140);
		public var bottomRightBallPoint = new Point(70,155);
		public var bottomLeftBallPoint = new Point(-70,155);
		
		//Character States
		var leftBumping = false;
		var rightBumping = false;
		var topBumping = false;
		var bottomBumping = false;
		var falling = false;
